...
const RequestRecordExe = () => {
  ...
  const initialValues: TRequestRecordExe = {
    profileType: "addRecordToExecutive",
  ...
  const onSubmit = (data: TRequestRecordExe) => {
    const userData: TRequestRecordPayloadExe = {
  ...
  const getError = (key: keyof TRequestRecordExe) => {
  ...
  return (
    <div className="bg-white">
      <form
        ...
        className="w-[90%] lg:w-[60%] xl:w-[40%] mx-auto py-[5em] space-y-4"
      >
...
export default RequestRecordExe;
