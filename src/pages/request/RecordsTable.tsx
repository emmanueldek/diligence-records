...
import { TRecordsRequestSchema } from "@/types";
        ...
        <tbody>
          {isLoading
            ...
            : data?.map((item, index) => (
                ...
                >
                  <td className=" px-3 py-4 whitespace-nowrap text-sm text-left">
                    {" "}
                  ...
                  <td className=" px-3 py-4  text-sm text-left hidden sm:table-cell">
                    {item?.profileType === "executive" ? (
                      <p className="flex items-center gap-2">
                        <Executive /> <span>Executive</span>
                      </p>
                    ) : (
                      <p className="flex items-center gap-2">
                  ...
                  <td className=" px-3 py-4  text-sm text-left hidden md:table-cell first-letter:uppercase">
                    {item?.recordSection}
                  </td>
                  <td className=" px-3 py-4 whitespace-nowrap text-sm text-left font-medium hidden sm:table-cell">
                    {formatDateString(item?.dateRequested)}
                  </td>
                  <td className=" px-3 py-4 whitespace-nowrap text-sm text-left">
                    <p
        ...
        <section className="h-full text-center ">
          ...
          <div className="mb-5">
            ...
            <p className="text-grey-400 md:text-xl">
              Request for a record and we will find it for you
            </p>
          </div>
